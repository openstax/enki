...
COPY            ./dockerfiles/build/build-stage-cookbook.sh \
    $PROJECT_ROOT/dockerfiles/build/build-stage-cookbook.sh
RUN $PROJECT_ROOT/dockerfiles/build/build-stage-cookbook.sh
