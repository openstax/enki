...
STEP_MAP.set('git-zybooks', {name: 'git-zybooks', inputs: [IO.BOOK, IO.ASSEMBLED], outputs: [IO.ZYBOOKS], env: {ARG_OPT_ONLY_ONE_BOOK: false, CODE_VERSION: true}})
STEP_MAP.set('git-assemble-meta', {name: 'git-assemble-meta', inputs: [IO.BOOK, IO.ZYBOOKS], outputs: [IO.ASSEMBLE_META], env: {ARG_OPT_ONLY_ONE_BOOK: false}})
