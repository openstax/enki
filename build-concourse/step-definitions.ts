...
STEP_MAP.set('git-zybooks', {name: 'git-zybooks', inputs: [IO.BOOK, IO.PRE_ZYBOOKS, IO.RESOURCES], outputs: [IO.ASSEMBLED, IO.RESOURCES], env: {ARG_OPT_ONLY_ONE_BOOK: false, CODE_VERSION: true}})
