...
set({name: 'step-upload-book', inputs: [IO.BOOK, IO.FETCH_META, IO.JSONIFIED, IO.RESOURCES, IO.ANCILLARY], outputs: [IO.ARTIFACTS], env: {
    CODE_VERSION: true,
    CORGI_ARTIFACTS_S3_BUCKET: true,
    PREVIEW_APP_URL_PREFIX: true,
    AWS_ACCESS_KEY_ID: true,
    AWS_SECRET_ACCESS_KEY: true,
    AWS_SESSION_TOKEN: false,
    CORGI_CLOUDFRONT_URL: false,
    REX_PROD_PREVIEW_URL: false,
    ANCILLARIES_HOST: false,
