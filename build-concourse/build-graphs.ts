...
import { GIT_PDF_STEPS, GIT_WEB_STEPS, Step, GIT_WEB_STEPS_WITH_DEQUEUE_AND_UPLOAD, GIT_GDOC_STEPS, CLI_GIT_EPUB_STEPS } from './step-definitions'
...
charts.push(['all-epub', buildChart(CLI_GIT_EPUB_STEPS)])
