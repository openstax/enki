...
const webBaker = {
    ...
    plan: [
        ...
        toConcourseTask('all-web-book', [IO.BOOK], [IO.COMMON_LOG], { AWS_ACCESS_KEY_ID: true, AWS_SECRET_ACCESS_KEY: true, AWS_SESSION_TOKEN: false, CODE_VERSION: env.codeVersion, QUEUE_BUCKET: env.queueBucket, COLUMNS: '80' }, readScript('script/all_web_book.sh')),
    ]
}
