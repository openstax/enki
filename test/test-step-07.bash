...
SKIP_DOCKER_BUILD=1 \
KCOV_DIR=_kcov06-a \
../enki --keep-data --data-dir $BOOK_DIR --command all-pptx --repo 'philschatz/tiny-book' --book-slug 'book-slug1' --ref main

SKIP_DOCKER_BUILD=1 \
KCOV_DIR=_kcov06-b \
STUB_UPLOAD="corgi" \
../enki --keep-data --data-dir $BOOK_DIR --command step-upload-pptx
...
SKIP_DOCKER_BUILD=1 \
../enki --data-dir $BOOK_DIR --command all-pptx --start-at step-disassemble --repo 'philschatz/tiny-book' --ref main
