...
expected_contents="s3 cp artifacts-single/$expected_book_slug.$expected_extension s3://openstax-sandbox-cops-artifacts/$expected_filename --content-type $expected_mime_type"
