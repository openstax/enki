...
SKIP_DOCKER_BUILD=1 \
KCOV_DIR=_kcov03 \
../enki --keep-data --data-dir $BOOK_DIR --command all-web --repo 'philschatz/tiny-book' --book-slug 'book-slug1' --ref @458dfb710e9af3d00d6f7e0be45fc819b955d931 --start-at step-disassemble
